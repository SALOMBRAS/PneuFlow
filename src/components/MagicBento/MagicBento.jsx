...
const cardData = [
  {
    color: '#120F17',
    title: 'Catálogo',
    description: 'Organize pneus, marcas e medidas',
    label: 'Produtos'
  },
  {
    color: '#120F17',
    title: 'Leads',
    description: 'Acompanhe contatos vindos da vitrine',
    label: 'WhatsApp'
  },
  {
    color: '#120F17',
    title: 'Vitrine',
    description: 'Seu link público sempre pronto para vender',
    label: 'Loja online'
  },
  {
    color: '#120F17',
    title: 'Vendedores',
    description: 'Links individuais com WhatsApp próprio',
    label: 'Equipe'
  },
  {
    color: '#120F17',
    title: 'Busca',
    description: 'Cliente encontra pneus por medida ou veículo',
    label: 'Conversão'
  },
  {
    color: '#120F17',
    title: 'Performance',
    description: 'Vitrine rápida e responsiva no celular',
    label: 'Mobile'
  }
];
...
const ParticleCard = ({
  ...
  return (
    <div
      ref={cardRef}
      className={`${className} magic-bento-particle-container`.trim()}
...
const useMobileDetection = () => {
  ...
  useEffect(() => {
    const checkMobile = () => {
      ...
      setIsMobile(window.innerWidth <= MOBILE_BREAKPOINT || reducedMotion);
    };
